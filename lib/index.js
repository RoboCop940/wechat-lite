 ...
 * @return {[type]}        [description]
 */
WeChat.request = function(url, params = {}){
...
WeChat.prototype.auth_token = function(code, grantType){
  return WeChat.request('get', WeChat.API_SNS + '/oauth2/access_token', {
    code      : code                  ,
    appid     : this.options.appId    ,
...
WeChat.prototype.auth_check_token = function(openId){
  return WeChat.request('get', WeChat.API_SNS + '/auth', { openid: openId });
};
...
WeChat.prototype.auth_refresh_token = function(refreshToken){
  return WeChat.request('get', WeChat.API_SNS + '/oauth2/refresh_token', {
    appid         : this.options.appId,
...
WeChat.prototype.auth_user = function(token, openId, language){
  return WeChat.request('get', WeChat.API_SNS + '/userinfo', {
    access_token : token,
    openid       : openId,
    lang         : language || 'en'
  });
...
WeChat.prototype.wxopen_template_send = function(to, form_id, templateId, value, data, page, color, emphasis_keyword){
  return WeChat.request('post', WeChat.API_CORE + '/message/wxopen/template/send', null, {
    touser          : to         ,
    template_id     : templateId ,
    page            : page       ,
    form_id         : form_id    ,
